...
namespace ug {
    ...
    namespace XBraidIntegrator {
        ...
        class SimpleIntegratorFactory : public ug::XBraidForUG4::IntegratorFactory<TDomain, TAlgebra> {
        public:
            ...
            SimpleIntegratorFactory() : ug::XBraidForUG4::IntegratorFactory<TDomain, TAlgebra>() {
