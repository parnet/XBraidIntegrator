...
namespace ug {
    ...
    namespace XBraidIntegrator {
        ...
        class TimeIntegratorLinearAdaptiveFactory : public ug::XBraidForUG4::IntegratorFactory<TDomain, TAlgebra> {
        public:
            ...
            TimeIntegratorLinearAdaptiveFactory() : ug::XBraidForUG4::IntegratorFactory<TDomain, TAlgebra>() {
            ...
            SPTimeIntegrator create_level_time_integrator(double current_dt, bool done, int level) override {
                ...
                auto integrator = make_sp(
                        new ug::TimeIntegratorLinearAdaptive<TDomain, TAlgebra>(m_time_disc_1, m_time_disc_2));
